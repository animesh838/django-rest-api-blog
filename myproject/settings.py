...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-vkt*+bkhcg31xh2wr+*dwkbda=5x=2u!!waaldnz(3mn&h7%oz')
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Allow all users by default
    ],
